...
from PyQt5.QtWidgets import QWidget, QLabel, QLineEdit, QTextEdit, QPushButton, QVBoxLayout, QHBoxLayout, QGridLayout, \
    QMessageBox
...
class AddressBook(QWidget):
    ...
    def submitContact(self):
        ...
        if name not in self.contacts:
            ...
            QMessageBox.information(self, "Add failed!",
                                    "Sorry but \%s\" is already in your address book" % name)
            return
